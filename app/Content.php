...
const ARA_DEFAULT_SETTINGS = [
    ...
    'contact_title'=>'Hubungi Kami','contact_text'=>'Ceritakan kebutuhan bisnis Anda dan tim kami akan menghubungi Anda.','contact_button'=>'Kirim','contact_email'=>'','contact_autoreply_enabled'=>'0','contact_autoreply_subject'=>'Terima kasih, pesan Anda sudah kami terima','contact_autoreply_body'=>'Halo {name},<br><br>Terima kasih sudah menghubungi {site_name}. Pesan Anda sudah kami terima dan tim kami akan segera menghubungi Anda.<br><br>Salam,<br>{site_name}','footer_text'=>'PT Ara DigiTalent','social_facebook'=>'','social_instagram'=>'','social_x'=>'','social_linkedin'=>'','social_whatsapp'=>'',
